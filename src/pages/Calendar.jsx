        ...
        <Flex gap="small" align="flex-start" vertical>
          <Flex gap="small" wrap="wrap">
            ...
            <Space direction="vertical" size={12}>
              <DatePicker
                className="centeredDatePicker"
                onChange={onChange}
                inputReadOnly
                needConfirm
                style={{ width: "500px", fontFamily: "Futura" }}
                format="Do MMMM YYYY"
                value={date}
              />
            </Space>
        ...
        >
          <div className="stat">
            ...
            <p>
              £
              {data.reduce(
                (total, item) => total + parseFloat(item.amount.slice(1)),
                0
              )}
            </p>
          </div>
          ...
          <div className="stat">
            ...
            <p>
              £
              {Math.max(
                ...data.map((item) => parseFloat(item.amount.slice(1)))
              )}
            </p>
          </div>
        </div>
